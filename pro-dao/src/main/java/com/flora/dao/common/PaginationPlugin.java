...
public class PaginationPlugin extends PluginAdapter {
	...
	public PaginationPlugin() {
		...
		properties.setProperty("log4j.appender.R.File", "D:/mybatisGenerator.log");// the
		// output file ,you can read from other config file
		properties.setProperty("log4j.appender.R.MaxFileSize", "1024000");// 去掉K
		// ,只忍数字
	...
	private void printElement(Element element, int deep) {
		if (element instanceof XmlElement) {
			...
			System.out.println((getBlank(deep) + "Element Name:" + element2.getName()));
			deep += 1;
			...
			System.out.println((getBlank(deep) + "Element Type:" + element.getClass().getSimpleName()));
		}
