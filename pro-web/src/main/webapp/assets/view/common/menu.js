jQuery(function(){
    ...
    var erpUrl = "http://deverp.dmall.com/" ;
...
function clearMenuAndHeader() {
    $("#sidebar").html("").addClass("hidden");
    $("#navbar").html("").addClass("hidden");
    $("#breadcrumbs").html("").addClass("hidden");
    $(".main-content").css("margin-left", 0);

    // 清除a标签中的target="_blank"，只执行10次
    var i = 0;
